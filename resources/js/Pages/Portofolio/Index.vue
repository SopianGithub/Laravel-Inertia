    ...
    <div class="portfolio">
        ...
        <header id="header">
            <div class="flex flex-col">
                ...
                <div class="position">
                    <img src="assets/img/profile-img.jpg" alt="" class="bg-gradient-to-t rounded-md">
                    <h1 class="text-gray-100"><a href="/portofolio">Yayan Sopian</a></h1>
        ...
        <section id="hero" class="flex flex-col justify-center items-center">
            ...
            <p class="grid grid-flow-col">
                ...
                <span>
                    <vue-typed-js :strings="['Developer', 'Fullstack Enginer']" :smartBackspace="true">
                        <h1 class="typing"></h1>
                    </vue-typed-js>
                </span>
            </p>
